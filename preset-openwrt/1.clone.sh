...
git clone --depth 1 https://github.com/xiechangan123/luci-i18n-xray-zh-cn.git
git clone --depth 1 https://github.com/freedmanop/luci-app-xray.git && mv luci-app-xray/core luci-app-xray-core && mv luci-app-xray/status luci-app-xray-status && rm -rf luci-app-xray
